            ...
            <section class="contactos">
                ...
                <ul>
                    <div class="social-icons">
                        <li><a href="#">
                                <i class="fab fa-facebook-f"><button type="button" onclick='msjautomatico()'>
                                        Facebook</button></i>
                            </a></li>
                        <li><a href="#">
                                <i class="fab fa-twitter"><button type="button" onclick='msjautomatico()'>
                                        Twitter</button></i>
                            </a></li>
                        <li><a href="#">
                                <i class="fab fa-instagram"><button type="button" onclick='msjautomatico()'>
                                        Instagram</button></i>
                            </a></li>
                        <li><a href="#">
                                <i class="fab fa-linkedin-in"><button type="button" onclick='msjautomatico()'>
                                        LinkedIn</button></i>
                            </a></li>
                    </div>
                </ul>
